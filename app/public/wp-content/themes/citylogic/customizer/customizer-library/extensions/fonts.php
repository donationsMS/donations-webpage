...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'citylogic' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'citylogic' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'citylogic' ),
		'cyrillic'     => __( 'Cyrillic', 'citylogic' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'citylogic' ),
		'devanagari'   => __( 'Devanagari', 'citylogic' ),
		'greek'        => __( 'Greek', 'citylogic' ),
		'greek-ext'    => __( 'Greek Extended', 'citylogic' ),
		'khmer'        => __( 'Khmer', 'citylogic' ),
		'latin'        => __( 'Latin', 'citylogic' ),
		'latin-ext'    => __( 'Latin Extended', 'citylogic' ),
		'vietnamese'   => __( 'Vietnamese', 'citylogic' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'citylogic' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'citylogic' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'citylogic' ),
